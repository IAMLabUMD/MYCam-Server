        ...
        try:
            ...
            if cmd == "test":
                ...
                if os.path.isfile(model_file):
                    copyfile(model_file,
                             "/home/jhong12/TOR-app-files/models/" + userID + "/model_" + category + "_prev.h5")
                if os.path.isfile(label_file):
                    copyfile(label_file,
                             "/home/jhong12/TOR-app-files/models/" + userID + "/label_" + category + "_prev.txt")
                ...
                224, 224, 3))  # imports the mobilenet model and discards the last 1000 neuron layer.
